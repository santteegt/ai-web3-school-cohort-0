...
> §2 for the current loop table and sequence diagram, and
> [`specs/scenarios/`](../specs/scenarios/) for the concrete Given/When/Then
> behavior per step. Do not edit this file — update the spec instead.
